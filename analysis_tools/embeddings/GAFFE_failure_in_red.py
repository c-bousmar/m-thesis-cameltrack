...
output_gif = os.path.join(info_folder, f"{method_name}_{video_name}_GAFFE_{frame_start}_{frame_end}_failure_in_red.gif")

# ============================================================
# IDENTIFY STARTING AND ENDING FRAMES PER SEQUENCE
# ============================================================
...
# ============================================================
# LOAD ID SWITCH EVENTS FROM CSV
# ============================================================
...
for f in range(frame_start, frame_end + 1):
    ...
    base_colors = np.full((len(track_ids), 3), 0.7)  # grey by default
    ...
    colors_current[highlight_mask] = [1.0, 0.0, 0.0]  # red for ID_S
    ...
    ax.set_title(f"{method_name.upper()} embeddings — {video_name}\nframes ≤ {f}")
    ax.set_xlabel("Dim 1")
    ax.set_ylabel("Dim 2")
    ax.legend()
